...
- Progressive JPEG scanline and raw component output are supported for one-shot
  APIs and seekable low-level decoder inputs. Progressive coefficient decoding
  is still rejected.
